...
singularity exec -B /proj:/proj /proj/applied_bioinformatics/common_data/kraken2.sif \
    ...
    -i $result_dir/kraken2/${sample}.kraken2.report \
    -w $result_dir/bracken/${sample}.bracken.report \
    -o $result_dir/bracken/${sample}.bracken.out
